...
Dir[AcaRails::Engine.root.join("spec/support/**/*.rb")].each {|f| require f}
...
RSpec.configure do |config|
  ...
  # If true, the base class of anonymous controllers will be inferred automatically. This will be the default behavior in future versions of rspec-rails.
